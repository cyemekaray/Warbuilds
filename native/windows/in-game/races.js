define({
  ...
  nightelf: [
...

    {
      ...
      BuildTable: [
        ['5/10 Food', '0:01', '4 wisps to Gold, 1 builds Altar. Build Wisps'],
        ['7/10 Food', '0:15', 'Fill Goldmine then Build 1st and 2nd Moon Wells (rest of Wisps to wood)'],
        ['10/20 Food', '1:06', 'Train Priestess of the Moon'],
        ['16/20 Food', '1:21', 'Build 3rd Moon Well'],
        ['20/20 Food + Hero Out', '2:03', 'Get Fire Arrow, Harass with Hero'],
        ['20/40 Food + ~200 Wood', '2:24', 'Build 4th Moon Well. Tech'],
        ['20/40 Food', '2:40', "Build Hunter's Hall. Research Nightvision. Build Shop"],
        ['20/40 Food + T2 Finish', '4:40', 'Build Ancient of Wind => Tech => Upgrade +1 Atk +1 Def = > Build 3 wells'],
        ['20/70 Food', '5:45', "Train 4 Faerie Dragons. Creep"],
        ['26/80 Food', '7:10', 'Build 2 Chimera Roosts. Mass Chimeras, research Upgrades (Corrosive Breath and +2/+3 Atk and Def). Get Hippogryphs as needed'],
      ],
      YoutubePro: '',
      YoutubeClan: '',
      ProsAndCons: [
        ['High-risk high reward cheese strat', 'If you get rushed it is probably game over'],
        ['', ''],
        ['', ''],
      ],
      Analysis:
        'I made this build for my girlfriend who just started playing wc3 and enjoyed fast teching to chims',
      Variations: ["You can tech faster if you don't build so many early wells but it may be hard to defend your base or creep without them due to the lack of healing"],
      DiscussionLink: 'https://www.clanat.org/forum/warbuilds-2/a-secure-fortune-kotg-alch-arch-t2-expo',
      Tips: [
        '',
        "",
